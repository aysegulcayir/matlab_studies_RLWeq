...
for t=ti:ti:tson
  A=zeros(n+1,n+1);
    ...
    uxk=eb1*g(1)+eb2*g(2)+eb3*g(3);
    b1=(1+ti*uxk/2)*ea1+ti*uk*eb1/2-mu*ec1;
    b2=(1+ti*uxk/2)*ea2+ti*uk*eb2/2-mu*ec2;
    b3=(1+ti*uxk/2)*ea3+ti*uk*eb3/2-mu*ec3;
    
    b4=ea1-mu*ec1;     b5=ea2-mu*ec2;    b6=ea3-mu*ec3;
    A(1,1)=b2-ea2*b1/ea1;A(1,2)=b3-ea3*b1/ea1;
    b(1)=b4*g(1)+b5*g(2)+b6*g(3);
    
    for i=2:n
    uk=ea1*g(i)+ea2*g(i+1)+ea3*g(i+2);
    uxk=eb1*g(i)+eb2*g(i+1)+eb3*g(i+2);
    b1=(1+ti*uxk/2)*ea1+ti*uk*eb1/2-mu*ec1;
    b2=(1+ti*uxk/2)*ea2+ti*uk*eb2/2-mu*ec2;
    b3=(1+ti*uxk/2)*ea3+ti*uk*eb3/2-mu*ec3;
    ...
    uxk=eb1*g(n+1)+eb2*g(n+2)+eb3*g(n+3);
    b1=(1+ti*uxk/2)*ea1+ti*uk*eb1/2-mu*ec1;
    b2=(1+ti*uxk/2)*ea2+ti*uk*eb2/2-mu*ec2;
    b3=(1+ti*uxk/2)*ea3+ti*uk*eb3/2-mu*ec3;
